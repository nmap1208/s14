...
class Admin(Basecalss):
    ...
    def create_school(self):
        ...
        Basecalss.save(self,"school",school_dict)
    def create_teacher(self):
        ...
        print(teacher_dict)
        Basecalss.save(self,"teacher",teacher_dict)
    def create_student(self):
        ...
        Basecalss.save(self,"student",student_dict)
    def create_course(self):
        ...
        course_dict['价格']=c1.course_price
        Basecalss.save(self,"classes",course_dict)
    def create_classes(self):
        ...
        Basecalss.save(self,'classes',classes_dict)


#学校类
class School(Basecalss):
...
class Teacher(Basecalss):
    ...
    def create_class_record(self):
        ...
        student_list=Basecalss.open(self,"student")
        ...
        Basecalss.seek_list(self,'calss_record',class_record)
    ...
    def create_class_grade(self):
        ...
        Basecalss.seek_list(self,'class_grade',class_grade)
    def teacher_view_grade(self):
        grade_list=[]
        student_school=input('校名:')
        student_class=input('班级:')
        student_times=input('课次:')
        class_grade_list=Basecalss.open(self,'class_grade')
    ...
    def teacher_view_record(self):
        ...
        student_class=input('班级:')
        student_times=input('课次:')
        class_record_list=Basecalss.open(self,'class_record')
...
class Student(Basecalss):
    ...
    def student_view_record(self):
        ...
        student_times=input('课次:')
        student_name=input('姓名:')
        class_record_list=Basecalss.open(self,'calss_record')
        for i in class_record_list:
            for j in i:
               if j['学校']==student_school and j['班级']==student_class and j['课次']==student_times and j['姓名']==student_name:
                    for key in j:
...
class Admin_view(Admin):
    ...
    def login(self):
        ...
        '''
        menu_dic={
            '1':Admin_view.school_manage,
            '2':Admin_view.teacher_manage,
            '3':Admin_view.student_manage,
            '4':Admin_view.course_manage,
            '5':'logout'
        }
...
class Run(object):
    ...
    def interactive(self):
        ...
        while not exit_flag:
            ...
            if option_view in menu_dict:
                if int(option_view)==4:
                    exit_flag=True
                else:
                    menu_dict[option_view].login(self)
            else:
                print('\033[31m;1m输入错误,重新输入\033[0m')
